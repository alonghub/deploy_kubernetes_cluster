...
stream {
    upstream backend {
        ...
        server 192.168.200.102:6443        max_fails=3 fail_timeout=30s;
        server 192.168.200.103:6443        max_fails=3 fail_timeout=30s;
        server 192.168.200.104:6443        max_fails=3 fail_timeout=30s;
    }
