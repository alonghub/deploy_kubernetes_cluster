...
``` bash
$ kubectl proxy --address='192.168.200.102' --port=8086 --accept-hosts='^*$'
Starting to serve on 192.168.200.102:8086
```

浏览器访问 URL：`http://192.168.200.102:8086/api/v1/namespaces/kube-system/services/kibana-logging/proxy`
